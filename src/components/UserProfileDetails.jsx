...
function UserProfileDetails() {
  ...
  return (
    <div className='flex items-center justify-center gap-4 relative'>
        ...
        overflow-hidden cursor-pointer bg-emerald-500'>
           {
             ...
             whileHover={{scale:1.2}}
              src={user?.photoURL}
               alt={user?.displayName} className='w-full h-full object-cover'
             >
             </motion.img>
             </>:
        ...
        whileTap={{scale:0.9}} className='p-4 rounded-md flex items-center justify-center cursor-pointer bg-secondary'>
